...
class FoodAdapter(private var lista: List<Recipe>, private var widthcard: Int, private var heightcard: Int, private val onClickListener:(Recipe) -> Unit) : RecyclerView.Adapter<FoodHolder>() {
    ...
    override fun onBindViewHolder(holder: FoodHolder, position: Int) {
        ...
        holder.init(item, onClickListener, widthcard, heightcard)
    }
